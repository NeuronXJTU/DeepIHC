...
class ChannelTransformer(nn.Module):
    def __init__(self, config, vis, img_size, channel_num=[64, 128, 256, 512], patchSize=[32, 32, 16, 8]):
        super().__init__()
        ...
        self.embeddings_3 = Channel_Embeddings(config,self.patchSize_3, img_size=img_size//2, in_channels=channel_num[2])
        self.embeddings_4 = Channel_Embeddings(config,self.patchSize_4, img_size=img_size//4, in_channels=channel_num[3])
