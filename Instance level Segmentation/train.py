...
from nets.yolact_training import Multi_Loss, get_lr_scheduler, set_optimizer_lr
...
if __name__ == "__main__":
    ...
    if True:
        ...
        for epoch in range(Init_Epoch, UnFreeze_Epoch):
            ...
            print("set_optimizer_lr") 
            set_optimizer_lr(optimizer, lr_scheduler_func, epoch)
            print("fit_one_epoch")
            fit_one_epoch(model_train, model, multi_loss, loss_history, optimizer, epoch, 
                    epoch_step, epoch_step_val, gen, gen_val, UnFreeze_Epoch, Cuda, fp16, scaler, save_period, save_dir,input_shape[0], local_rank)
